...
class LocalStaticCatalogSpider(scrapy.Spider):
    name = "local_static_catalog"
    ...
    def parse(self, response):
        for product in response.css(".product-card"):
            yield {
                ...
                "detail_url": response.urljoin(product.css(".detail-link::attr(href)").get()),
